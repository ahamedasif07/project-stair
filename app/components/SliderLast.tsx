  ...
  return (
    <div className="carousel-container">
      <style jsx>{`
        ...
        .slide-card.right-1 {
          transform: translate(-50%, -50%) translateX(420px) translateZ(-350px)
            rotateY(-42deg) scale(0.82);
          z-index: 8;
          opacity: 0.75;
        ...
        .slide-card.right-2 {
          transform: translate(-50%, -50%) translateX(720px) translateZ(-600px)
            rotateY(-48deg) scale(0.68);
          z-index: 6;
          opacity: 0.5;
        ...
        @media (max-width: 1400px) {
          ...
          .slide-card.right-1 {
            transform: translate(-50%, -50%) translateX(380px)
              translateZ(-350px) rotateY(-42deg) scale(0.82);
          }
          ...
          .slide-card.right-2 {
            transform: translate(-50%, -50%) translateX(650px)
              translateZ(-600px) rotateY(-48deg) scale(0.68);
          }
        ...
        @media (max-width: 1024px) {
          ...
          .slide-card.right-2 {
            transform: translate(-50%, -50%) translateX(580px)
              translateZ(-600px) rotateY(-48deg) scale(0.68);
          }
        ...
        @media (max-width: 768px) {
          ...
          .slide-card.right-1 {
            transform: translate(-50%, -50%) translateX(280px)
              translateZ(-300px) rotateY(-40deg) scale(0.75);
          }
        ...
        @media (max-width: 480px) {
          ...
          .slide-card.right-1 {
            transform: translate(-50%, -50%) translateX(220px)
              translateZ(-250px) rotateY(-38deg) scale(0.7);
            opacity: 0.6;
          }
